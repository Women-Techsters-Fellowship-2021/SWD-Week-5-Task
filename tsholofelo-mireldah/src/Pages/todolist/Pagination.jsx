...
const Pagination = ({pages, setCurrentPage, currentTodos, sortedTodos}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentTodos.length}</b> out of <b>{sortedTodos.length}</b> entries</div>
